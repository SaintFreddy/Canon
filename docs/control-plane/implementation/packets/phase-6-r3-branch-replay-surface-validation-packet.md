# Phase 6 R3 branch replay surface and validation packet
Version: 1.0
Status: Accepted
Task: P6.6 — Agent execution packets
Artifact ID: pkt.phase6-r3-branch-replay-surface-validation-packet.v1
...
File whitelist ref: wl.phase6-r3-branch-replay-surface-validation.v1

This packet is accepted for downstream use.
It delegates one bounded surface-validation slice of the accepted R3 branch replay implementation blueprint.
...
```json
{
  "packet_id": "pkt.phase6-r3-branch-replay-surface-validation-packet.v1",
  "title": "Phase 6 R3 branch replay surface and validation packet",
  "task_id": "P6.6",
  "objective": "Implement the R3 branch replay app, projection, inspect, test, and fixture slice from the accepted release blueprint inside bounded surface-validation scope.",
  "scope": [
    "Implement only the R3 branch replay app, projection-grammar, inspect, test, and fixture clusters named in the whitelist.",
  ...
  "accepted_artifact_refs": [
    "bp.phase6-r3-branch-replay-blueprint.v1",
  ...
  "file_whitelist_ref": "wl.phase6-r3-branch-replay-surface-validation.v1",
  "deliverables": [
    "Implemented R3 branch replay app surfaces, projection helpers, contract tests, and fixture assets inside the named whitelist.",
  ...
  "carry_forward_topics": [
    "r3-branch-replay surface_validation packet",
  ...
  "notes": [
    ...
    "Prerequisite packets: pkt.phase6-r3-branch-replay-runtime-execution-packet.v1"
  ]
}
```

## File whitelist `wl.phase6-r3-branch-replay-surface-validation.v1`

- `apps/chat-native/r3-branch-replay/`
- `apps/chat-native/r3-mode-projection/`
- `packages/projection-grammar/branch-projection/`
- `packages/monitor-inspect/branch-compare/`
- `tests/contracts/r3-branch-replay/`
- `tests/fixtures/r3-branch-replay/`
...
- This packet slices `bp.phase6-r3-branch-replay-blueprint.v1` along the bounded `surface_validation` family rather than widening one release packet beyond the accepted standard band.

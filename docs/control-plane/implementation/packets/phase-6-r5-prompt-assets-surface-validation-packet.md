# Phase 6 R5 prompt assets surface and validation packet
Version: 1.0
Status: Accepted
Task: P6.6 — Agent execution packets
Artifact ID: pkt.phase6-r5-prompt-assets-surface-validation-packet.v1
...
File whitelist ref: wl.phase6-r5-prompt-assets-surface-validation.v1

This packet is accepted for downstream use.
It delegates one bounded surface-validation slice of the accepted R5 prompt assets implementation blueprint.
...
```json
{
  "packet_id": "pkt.phase6-r5-prompt-assets-surface-validation-packet.v1",
  "title": "Phase 6 R5 prompt assets surface and validation packet",
  "task_id": "P6.6",
  "objective": "Implement the R5 prompt assets app, projection, inspect, test, and fixture slice from the accepted release blueprint inside bounded surface-validation scope.",
  "scope": [
    "Implement only the R5 prompt assets app, projection-grammar, inspect, test, and fixture clusters named in the whitelist.",
  ...
  "source_authority_refs": [
    "rel.r5-prompt-studio-contract.v1"
  ],
  "accepted_artifact_refs": [
    "bp.phase6-r5-prompt-assets-blueprint.v1",
  ...
  "file_whitelist_ref": "wl.phase6-r5-prompt-assets-surface-validation.v1",
  "deliverables": [
    "Implemented R5 prompt assets app surfaces, projection helpers, contract tests, and fixture assets inside the named whitelist.",
  ...
  "carry_forward_topics": [
    "r5-prompt-assets surface_validation packet",
  ...
  "notes": [
    ...
    "Prerequisite packets: pkt.phase6-r5-prompt-assets-runtime-execution-packet.v1"
  ]
}
```

## File whitelist `wl.phase6-r5-prompt-assets-surface-validation.v1`

- `apps/chat-native/r5-prompt-assets/`
- `apps/chat-native/r5-model-profile-browser/`
- `packages/projection-grammar/prompt-asset-projection/`
- `packages/monitor-inspect/prompt-browser/`
- `tests/contracts/r5-prompt-assets/`
- `tests/fixtures/r5-prompt-assets/`
...
- This packet slices `bp.phase6-r5-prompt-assets-blueprint.v1` along the bounded `surface_validation` family rather than widening one release packet beyond the accepted standard band.

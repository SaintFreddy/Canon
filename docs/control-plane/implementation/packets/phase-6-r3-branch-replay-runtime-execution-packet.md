# Phase 6 R3 branch replay runtime execution packet
Version: 1.0
Status: Accepted
Task: P6.6 — Agent execution packets
Artifact ID: pkt.phase6-r3-branch-replay-runtime-execution-packet.v1
...
File whitelist ref: wl.phase6-r3-branch-replay-runtime-execution.v1

This packet is accepted for downstream use.
It delegates one bounded runtime-execution slice of the accepted R3 branch replay implementation blueprint.
...
```json
{
  "packet_id": "pkt.phase6-r3-branch-replay-runtime-execution-packet.v1",
  "title": "Phase 6 R3 branch replay runtime execution packet",
  "task_id": "P6.6",
  "objective": "Implement the R3 branch replay runtime services/workers slice from the accepted release blueprint inside bounded execution scope without widening into packages, apps, or tests outside the whitelist.",
  "scope": [
    "Implement only the R3 branch replay services and workers named in the whitelist.",
  ...
  "file_whitelist_ref": "wl.phase6-r3-branch-replay-runtime-execution.v1",
  "deliverables": [
    "Implemented R3 branch replay services and workers inside the named whitelist.",
  ...
  "carry_forward_topics": [
    "r3-branch-replay runtime_execution packet",
  ...
  "notes": [
    ...
    "Prerequisite packets: pkt.phase6-r3-branch-replay-contracts-objects-packet.v1"
  ]
}
```

## File whitelist `wl.phase6-r3-branch-replay-runtime-execution.v1`

- `services/execution-control/checkpoint-launch/`
- `services/review-writeback/merge-proposals/`
- `services/event-provenance/branch-history/`
- `workers/replay-compare/checkpoint-replay/`
- `workers/replay-compare/branch-compare/`
...
- This packet slices `bp.phase6-r3-branch-replay-blueprint.v1` along the bounded `runtime_execution` family rather than widening one release packet beyond the accepted standard band.

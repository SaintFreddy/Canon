# Phase 6 R2 context control runtime execution packet
Version: 1.0
Status: Accepted
Task: P6.6 — Agent execution packets
Artifact ID: pkt.phase6-r2-context-control-runtime-execution-packet.v1
...
File whitelist ref: wl.phase6-r2-context-control-runtime-execution.v1

This packet is accepted for downstream use.
It delegates one bounded runtime-execution slice of the accepted R2 context control implementation blueprint.
...
```json
{
  "packet_id": "pkt.phase6-r2-context-control-runtime-execution-packet.v1",
  "title": "Phase 6 R2 context control runtime execution packet",
  "task_id": "P6.6",
  "objective": "Implement the R2 context control runtime services/workers slice from the accepted release blueprint inside bounded execution scope without widening into packages, apps, or tests outside the whitelist.",
  "scope": [
    "Implement only the R2 context control services and workers named in the whitelist.",
  ...
  "file_whitelist_ref": "wl.phase6-r2-context-control-runtime-execution.v1",
  "deliverables": [
    "Implemented R2 context control services and workers inside the named whitelist.",
  ...
  "carry_forward_topics": [
    "r2-context-control runtime_execution packet",
  ...
  "notes": [
    ...
    "Prerequisite packets: pkt.phase6-r2-context-control-contracts-objects-packet.v1"
  ]
}
```

## File whitelist `wl.phase6-r2-context-control-runtime-execution.v1`

- `services/environment-shell-api/context-operations/`
- `services/execution-control/rerun-from-pack/`
- `services/event-provenance/pack-lineage/`
- `workers/context-compiler/pack-freeze-diff/`
- `workers/replay-compare/pack-basis-compare/`
...
- This packet slices `bp.phase6-r2-context-control-blueprint.v1` along the bounded `runtime_execution` family rather than widening one release packet beyond the accepted standard band.

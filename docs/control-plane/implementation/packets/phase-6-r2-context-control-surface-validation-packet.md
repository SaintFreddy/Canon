# Phase 6 R2 context control surface and validation packet
Version: 1.0
Status: Accepted
Task: P6.6 — Agent execution packets
Artifact ID: pkt.phase6-r2-context-control-surface-validation-packet.v1
...
File whitelist ref: wl.phase6-r2-context-control-surface-validation.v1

This packet is accepted for downstream use.
It delegates one bounded surface-validation slice of the accepted R2 context control implementation blueprint.
...
```json
{
  "packet_id": "pkt.phase6-r2-context-control-surface-validation-packet.v1",
  "title": "Phase 6 R2 context control surface and validation packet",
  "task_id": "P6.6",
  "objective": "Implement the R2 context control app, projection, inspect, test, and fixture slice from the accepted release blueprint inside bounded surface-validation scope.",
  "scope": [
    "Implement only the R2 context control app, projection-grammar, inspect, test, and fixture clusters named in the whitelist.",
  ...
  "source_authority_refs": [
    "rel.r2-context-chat-contract.v1"
  ],
  "accepted_artifact_refs": [
    "bp.phase6-r2-context-control-blueprint.v1",
  ...
  "file_whitelist_ref": "wl.phase6-r2-context-control-surface-validation.v1",
  "deliverables": [
    "Implemented R2 context control app surfaces, projection helpers, contract tests, and fixture assets inside the named whitelist.",
  ...
  "carry_forward_topics": [
    "r2-context-control surface_validation packet",
  ...
  "notes": [
    ...
    "Prerequisite packets: pkt.phase6-r2-context-control-runtime-execution-packet.v1"
  ]
}
```

## File whitelist `wl.phase6-r2-context-control-surface-validation.v1`

- `apps/chat-native/r2-context-control/`
- `apps/chat-native/r2-pack-inspect/`
- `packages/projection-grammar/context-control-projection/`
- `packages/monitor-inspect/context-pack-inspect/`
- `tests/contracts/r2-context-control/`
- `tests/fixtures/r2-context-control/`
...
- This packet slices `bp.phase6-r2-context-control-blueprint.v1` along the bounded `surface_validation` family rather than widening one release packet beyond the accepted standard band.
